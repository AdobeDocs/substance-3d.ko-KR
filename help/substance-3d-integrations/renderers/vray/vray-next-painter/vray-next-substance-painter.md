...
>[!NOTE]
>
> 프로젝트가 [UV 타일 UDIM 레거시](https://helpx.adobe.com/substance-3d/unlisted/documentation/spdoc/uv-tile-udim-legacy-144310352.html)를 사용하도록 설정된 경우. [다음 UDIM 출력 템플릿 표시]를 사용합니다.
