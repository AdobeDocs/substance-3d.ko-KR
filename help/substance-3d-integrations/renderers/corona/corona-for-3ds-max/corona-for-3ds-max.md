...
[3ds Max 플러그인](../../../3d-applications/3ds-max/3ds-max.md)을 사용하면 Substance 메뉴에서 Corona를 선택하여 Substance 텍스처 입력으로 Corona 재질을 자동으로 설정할 수 있습니다.
...
* **CoronaNormal**&#x200B;은(는) Normal 출력과 Base 범프 입력 사이와 코팅 정상 출력과 Clearcoat 범프 입력 사이에 만들어집니다. 설정은 변경되지 않지만 일반은 여기에서 수정할 수 있습니다.
