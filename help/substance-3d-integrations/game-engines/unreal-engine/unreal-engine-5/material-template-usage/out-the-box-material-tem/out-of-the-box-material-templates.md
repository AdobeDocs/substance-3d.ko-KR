...
일반 UV 경험을 위한 기본 재질 템플릿입니다. 그것은 당신이 일부 UV 텍스처에 대한 UV의 크기를 조정할 수 있도록 UV 양의 기본 컨트롤을 제공합니다. [UV 분할] 옵션을 활성화하여 UV 비율을 분할할 수 있으며, U 양, V 양, UV 오프셋 및 UV 회전 각도도 있습니다. 이렇게 하면 UV 회전뿐만 아니라 일부 UV 타일링을 수행할 수 있습니다.
...
트리평면 템플릿은 물리적 크기를 지원하므로 물리적 크기를 활성화하면 트리평면 템플릿이 재질의 물리적 크기에 따라 이미지의 크기를 조절하므로 개체의 크기를 얼마나 조절하든 해당 텍스처는 항상 동일하게 유지되고 균일한 모양을 갖게 됩니다. 여기에서 물리적 크기 자세히 알아보기: [물리적 크기 - UE5](../../../../../game-engines/unreal-engine/unreal-engine-5/physical-size-ue5/physical-size-ue5.md)

## Substance 굴절 템플릿

굴절 템플릿은 주로 투명 개체, 예를 들어 안경에 사용됩니다. 이를 통해 유리 재질 또는 투명 재질에 대해 가질 수 있는 IOR 값 또는 표준 텍스처를 수정할 수 있습니다.

![](../../../../../assets/screen-shot-2022-05-10-at-9-07-38-pm.png)

## Substance 자동차 페인트 템플릿

자동차 페인트 템플릿은 투명 코트 지원을 추가하며 조정 가능한 UV 타일링 및 값, 투명 코팅 거칠기 값 및 프레넬 전원 값을 지원합니다.

![Substance 자동차 페인트 자료에 대한 세부 정보 메뉴](../../../../../assets/car-paint-template.png)
