...
| **GetSubstanceTexture** | 입력: **SubstanceGraphInstance** | Substance 그래프 인스턴스 입력 매개 변수에서 활성화된 모든 텍스처와 현재 계산된 텍스처의 배열을 반환합니다. |
...
| **DisableInstanceOutput** | 입력: **SubstanceGraphInstance** - 입력을 비활성화하는 출력이 포함된 그래프 인스턴스: **OutputIndexes**(int32 배열) - 비활성화하려는 출력의 인덱스입니다. | 활성화된 경우 은 그래프 객체에서 전달된 텍스처 출력을 사용하지 않고 삭제합니다 |
