...
| setInputString | 새 값으로 문자열 입력 설정 |  |  | ***문자열 매개 변수***: **값** 입력을 {String 매개 변수로 설정할 문자열 값&#x200B;***:** inputIdentifier** 입력의 고유 문자열 식별자입니다*** |
| setInputBool | 새 값을 사용하여 부울 입력 설정 |  |  | ***부울 매개 변수:* 값&#x200B;**입력을 {String 매개 변수*** 설정하는 부울 값&#x200B;*** **inputIdentifier** 입력의 고유 문자열 식별자 |
