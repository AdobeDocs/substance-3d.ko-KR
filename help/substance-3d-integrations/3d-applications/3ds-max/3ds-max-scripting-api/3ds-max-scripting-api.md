...
| setInputInt | 새 값을 사용하여 정수 입력 설정 |  |  | ***정수 매개 변수***: **값** 입력을 {String 매개 변수로 설정할 정수 값&#x200B;***:** inputIdentifier&#x200B;***5} 입력의 고유 문자열 식별자입니다** |
| setInputFloat | 새 값으로 부동 입력 설정 |  |  | ***Float 매개 변수***: **값** 입력을 {String 매개 변수로 설정하는 Float 값&#x200B;***:** inputIdentifier&#x200B;***5} 입력의 고유 문자열 식별자** |
| setInputString | 새 값으로 문자열 입력 설정 |  |  | ***문자열 매개 변수***: **값** 입력을 &lbrace;String 매개 변수로 설정할 문자열 값&#x200B;***:** inputIdentifier **&#x200B; 입력의 고유 문자열 식별자입니다*** |
| setInputBool | 새 값을 사용하여 부울 입력 설정 |  |  | ***부울 매개 변수:* 값&#x200B;**&#x200B;입력을 &lbrace;String 매개 변수&#x200B;*** 설정하는 부울 값&#x200B;*** **inputIdentifier** 입력의 고유 문자열 식별자 |
...
| getInputComboSelection | 식별자를 기반으로 콤보 상자 선택 항목의 인덱스를 가져옵니다. | 선택한 콤보 상자 항목의 인덱스입니다 | 정수 | ***문자열 매개 변수:* inputIdentifier &#x200B;** 입력의 고유 문자열 식별자입니다. |
