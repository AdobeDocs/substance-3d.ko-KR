...
* Substance 3d Painter에서 저장되지 않은 파일 내보내기를 처리하기 위해 사용하는 경로를 에뮬레이션하는 기본 텍스처 내보내기 경로(시간 폴더)
* $matName과 같은 키를 사용하여 하위 폴더를 만드는 옵션을 사용하여 위와 동일한 텍스처 상대 경로
