...
breadcrumb-title: ''
description: SSS 셰이더와 마스크에 사용하기 위해 메시 표면에서 안쪽으로 광선을 캐스팅하여 두께 맵을 생성합니다.
...
메쉬의 두께 맵은 앰비언트 오클루전 제빵기와 매우 유사하지만 메쉬 표면에서 내부로 광선을 방출합니다. 이 텍스처는 SSS(Sub Surface Scattering) 셰이더 또는 마스킹 텍스처에 사용할 수 있습니다.
