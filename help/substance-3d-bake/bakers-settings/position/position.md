...
breadcrumb-title: ''
description: 메쉬 형상 위치를 계산하고 텍스처에 저장하여 볼륨 기반 효과와 그레이디언트 마스크를 만듭니다.
...
| *매개 변수* | *설명* |
| --- | --- |
| **모드** | 위치 텍스처로 계산할 정보를 제어합니다.가능한 값:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>모든 축:</strong> X, Y 및 Z축의 위치를 출력 텍스처의 RGB 채널로 바꿉니다.</li><li data-preserve-html="true"><strong>한 축:</strong> 한 축을 회색 음영 이미지로 출력 텍스처에 바꿈합니다.</li></ul> |
