...
breadcrumb-title: ''
description: 향상된 사실감을 위해 광선 추적 기술을 사용하여 하이 폴리 메쉬에서 정확한 주변 오클루전 텍스처를 구워냅니다.
...
메쉬 베이커의 앰비언트 오클루전을 사용하면 높은 폴리 메쉬에서 앰비언트 오클루전 텍스처를 베이킹할 수 있습니다. 기본 [주변 오클루전](../../bakers-settings/ambient-occlusion/ambient-occlusion.md) 베이커보다 느리지만 더 정확한 결과를 생성합니다.
