...
> **설명**
> 
> [케이지](https://helpx.adobe.com/substance-3d/unlisted/documentation/bake/cage-projection-172822982.html)를 사용하지 않으면 베이킹 프로세스가 낮은 폴리 메쉬의 꼭지점 법선 방향으로 광선을 시작합니다. 각 꼭지점 법선이 분할되면(각 면이 인접 면과 동일한 꼭지점 법선을 공유하지 않는다는 의미) 광선이 가장자리에 있는 동일한 방향으로 전송되지 않습니다. 그러면 각 모서리 면의 정보가 다르기 때문에 분할됩니다.
> 
...
> 
> * 베이커에서 낮은 폴리 기하학에서 광선 방향을 계산하도록 하는 대신 [케이지](https://helpx.adobe.com/substance-3d/unlisted/documentation/bake/cage-projection-172822982.html)를 사용하여 광선 방향을 제어합니다.
